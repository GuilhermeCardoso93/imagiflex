...
const Footer = () => {
  ...
  return (
    <footer className="mt-32 px-12 text-gray-600 text-sm">
      <FontAwesomeIcon className="mr-4 hover:text-white cursor-pointer" icon={faFacebookSquare} size="2x" />
      <FontAwesomeIcon className="mr-4  hover:text-white cursor-pointe" icon={faInstagram} size="2x"/>
      ...
      <div className="grid  grid-cols-4 gap-2 my-8 pb-4">
